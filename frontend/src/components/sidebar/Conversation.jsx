...
const Conversation = ({conversation, lastIdx, emoji}) => {
  ...
  return (
    <>
        <div className={`flex gap-2 items-start hover:bg-sky-500 rounded p-2 py-1 cursor-pointer ${isSelected ? "bg-sky-500" : ""}`}
...
//   return (
//     <>
//         <div className='flex gap-2 items-start hover:bg-sky-500 rounded p-2 py-1 cursor-pointer'>
//             <div className='avatar online'>
//                 <div className='w-12 rounded-full'>
